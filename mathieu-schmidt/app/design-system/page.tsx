      ...
      <nav className="fixed top-0 w-full z-50 bg-card backdrop-blur-sm border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-lg font-serif font-semibold text-dusty">Design System</div>
      ...
      <main className="pt-24 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16 text-center">
            <h1 className="text-5xl font-serif text-foreground mb-4">Design System</h1>
            <p className="text-xl text-muted max-w-3xl mx-auto">
              The visual language and components that create the lonely prairie aesthetic 
              for Mathieu Schmidt&apos;s artist website.
            </p>
          </div>

          {/* Color Palette */}
          <section className="mb-16">
            <h2 className="text-3xl font-serif text-foreground mb-8">Color Palette</h2>
            <p className="text-muted mb-8 text-lg">
              Inspired by the muted, earthy tones of prairie landscapes and weathered materials.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              {/* Atmospheric Colors */}
              <div className="space-y-4">
                <h3 className="font-serif text-lg text-foreground">Atmospheric</h3>
                <div className="space-y-3">
          ...
          {/* Typography */}
          <section className="mb-16">
            <h2 className="text-3xl font-serif text-foreground mb-8">Typography</h2>
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="font-serif text-2xl text-foreground mb-6">Crimson Text (Serif)</h3>
                <div className="space-y-6">
                  <div>
                    <h1 className="text-4xl font-serif">Heading 1 - Display</h1>
                    <p className="text-muted text-sm mt-2">Used for main titles and hero text</p>
                  </div>
                  <div>
                    <h2 className="text-3xl font-serif">Heading 2 - Section</h2>
                    <p className="text-muted text-sm mt-2">Section headings and important titles</p>
                  </div>
                  <div>
                    <h3 className="text-2xl font-serif">Heading 3 - Subsection</h3>
                    <p className="text-muted text-sm mt-2">Subsection headers and card titles</p>
                  </div>
                  <div>
                    <p className="font-serif text-lg italic text-muted">
                      &ldquo;Elegant serif for quotes and atmospheric text&rdquo;
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="font-serif text-2xl text-foreground mb-6">Inter (Sans-serif)</h3>
                <div className="space-y-6">
                  <div>
                    <p className="text-lg">Body text - Large</p>
                    <p className="text-muted text-sm mt-2">Main paragraph text for readability</p>
                  </div>
                  <div>
                    <p className="text-base">Body text - Regular</p>
                    <p className="text-muted text-sm mt-2">Secondary content and descriptions</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted">Small text - Captions and metadata</p>
                    <p className="text-muted text-xs mt-2">For less important information</p>
                  </div>
                  <div>
                    <p className="font-medium text-sage">Medium weight for buttons and links</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-serif text-foreground mb-8">Interactive Elements</h2>
            
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="font-serif text-xl text-foreground mb-6">Buttons</h3>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted text-sm mt-2">Main call-to-action buttons</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm mt-2">Secondary actions and navigation</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm mt-2">Inline links and subtle actions</p>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="font-serif text-xl text-foreground mb-6">Navigation</h3>
                <div className="space-y-4">
                  <div>
                    <nav className="bg-card border border-border rounded-lg p-4">
                      <div className="flex space-x-6">
                        <a href="#" className="text-sage font-medium">Active</a>
                        <a href="#" className="text-muted hover:text-sage transition-colors">Inactive</a>
                        <a href="#" className="text-muted hover:text-sage transition-colors">Link</a>
                      </div>
                    </nav>
                    <p className="text-muted text-sm mt-2">Main navigation styling</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-serif text-foreground mb-8">Layout Components</h2>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-card rounded-lg p-6 border border-border">
                    <h4 className="font-serif text-lg text-foreground mb-2">Content Card</h4>
                  ...
                  <div className="bg-sage/10 border border-sage/20 rounded-lg p-6">
                    <h4 className="font-serif text-lg text-foreground mb-2">Highlighted Card</h4>
                    <p className="text-muted">
                      Subtle accent cards for featured content or important information.
                      Uses the primary color with low opacity.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="font-serif text-xl text-foreground mb-4">Dividers & Spacing</h3>
                <div className="space-y-6">
                  <div>
                    <div className="w-24 h-px bg-sage mx-auto"></div>
                    <p className="text-center text-muted text-sm mt-2">Accent divider line</p>
                  </div>
                  
                  <div>
                    <hr className="border-border" />
                    <p className="text-center text-muted text-sm mt-2">Standard section divider</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Usage Guidelines */}
          <section className="mb-16">
            <h2 className="text-3xl font-serif text-foreground mb-8">Usage Guidelines</h2>
            
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="font-serif text-xl text-foreground mb-4">Spacing</h3>
              ...
              <div>
                <h3 className="font-serif text-xl text-foreground mb-4">Aesthetic Principles</h3>
                <ul className="space-y-2 text-muted">
          ...
          <section>
            <h2 className="text-3xl font-serif text-foreground mb-8">Color Usage in Context</h2>
            
            <div className="grid gap-8">
              <div className="bg-card rounded-lg p-6 border border-border">
                <h3 className="font-serif text-2xl text-foreground mb-4">Example Section</h3>
                <p className="text-muted mb-4">
                  This demonstrates how the color palette works together in a real section. 
                  The sage green is used sparingly for accents and interactive elements.
                </p>
              ...
              <div className="bg-stone/10 rounded-lg p-6">
                <h4 className="font-serif text-lg text-foreground mb-2 text-dusty">Atmospheric Quote</h4>
                <blockquote className="text-muted italic text-lg border-l-4 border-sage pl-6">
                  &ldquo;The prairie teaches patience - in its vastness, there&apos;s time for every thought 
                  to settle like dust after a storm.&rdquo;
                </blockquote>
              </div>
            </div>
          </section>
